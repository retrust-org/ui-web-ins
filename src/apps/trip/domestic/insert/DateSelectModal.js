  ...
  return (
    <>
      ...
      >
        ...
        <div
          ref={modalRef}
          className="commonModal bg-white rounded-t-[30px] md:rounded-t-[40px] overflow-hidden mx-auto z-10 w-[100%] py-4 px-5 fixed bottom-0 inset-x-0 animate-slideIn pb-4"
        >
