...
const InsurancePDFTemplate = ({
  ...
  // 통합된 보장내용 (첫 번째 가입자의 보장내용 사용)
  const coverageList = currentPlanData.insuredPersons[0]?.opapiGnrCoprCtrQuotCovInfCbcVo || [];
    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <Text style={styles.documentTitle}>단체 국내여행자보험 견적서</Text>
          ...
          <View style={styles.infoGrid}>
            ...
            <View style={styles.infoColumn}>
              ...
              <View style={styles.infoRow}>
                <Text style={styles.label}>총 가입자수</Text>
                <Text style={styles.value}>{currentPlanData.insuredPersons.length}명</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        {/* 통합 보장내용 */}
        <View>
          <Text style={styles.sectionTitle}>보장내용</Text>
          <View style={styles.table}>
            <View style={styles.tableHeader}>
              <Text style={styles.tableHeaderCell}>보장명</Text>
              <Text style={styles.tableHeaderCellRight}>보상한도</Text>
            </View>
            {coverageList.map((coverage, idx) => (
              <View
                key={idx}
                style={[
                  styles.tableRow,
              ...
              >
                <Text style={styles.tableCell}>{coverage.covNm}</Text>
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.coverageTitle}>가입자별 보험료</Text>
        </View>
