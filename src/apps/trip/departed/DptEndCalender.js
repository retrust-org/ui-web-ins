      ...
      <div className="relative">
        {isStartDate && (
          <div className="absolute top-[-20px] left-0 w-full text-center">
            <span className="text-[12px] font-normal text-black h-0">
              출발일
            </span>
          </div>
        )}
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="ko">
      <div className="w-full max-w-[440px] mx-auto bg-white rounded-2xl">
        ...
        <div className="pb-4">
          <button
            className="w-full py-4 sm:py-4 rounded-xl text-white font-semibold text-[13px] sm:text-sm transition-all duration-200 hover:opacity-90 active:transform active:scale-[0.98]"
