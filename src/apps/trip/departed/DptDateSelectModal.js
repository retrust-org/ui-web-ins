...
import StartCalendar from "./DptStartCalendar";
import EndCalendar from "./DptEndCalender";
import styles from "../../../css/trip/insert.module.css";

function DptDateSelectModal({
  isOpen,
  onClose,
  isStartModal,
  startDate,
    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="text-[#e86565] px-2  text-[12px] lg:pb-2">
            *출국 후 24시간 이내인 경우에만 가입이 가능합니다.
            <br />
            *도착일-입국날짜를 선택해주세요.
          </p>
...
export default DptDateSelectModal;
