...
const Wound = () => {
  ...
  return (
    <TableLayout footerText={footerText}>
      ...
      {/* 교통사고 */}
      <tr>
        <CategoryCell>교통사고</CategoryCell>
        <ContentCell>
          <List>
            <ListItem>교통사고 사실확인원</ListItem>
            <ListItem>자동차보험 지급결의서(보상내역서)</ListItem>
            <ListItem>교통사고 처리확인원</ListItem>
      ...
      {/* 골절 */}
      <tr>
        <CategoryCell>골절</CategoryCell>
        <ContentCell>
          <List>
            <ListItem>진단서(골절부위 및 진단명 기재)</ListItem>
            <ListItem>진료차트</ListItem>
            <ListItem>X-ray 영상 또는 판독결과지</ListItem>
          </List>
        </ContentCell>
        <SourceCell>의료기관</SourceCell>
      </tr>
