...
import styles from "../../../../css/disasterHouse/LimitsAnnounce.module.css";
...
function LimitsAnnounce() {
  ...
  const nextBtn = async () => {
    ...
    try {
      ...
      console.log('초과가입 제한 안내 동의 기록 완료 (template:', TEMPLATE_ID, ')');
      navigate("/agreement");
    } catch (err) {
  ...
  return (
    <>
      <DisasterHeader title="실손보상 주택 풍수해·지진재해보험" backPath="/price" />
