...
import styles from '../../../../css/disasterHouse/insuranceDate.module.css'
...
function InsuranceDate() {
    ...
    const { contractData, updateContractData } = useDisasterHouse();
    ...
    return (
        <>
            <DisasterHeader title="실손보상 주택 풍수해·지진재해보험" backPath="/address/result" />
