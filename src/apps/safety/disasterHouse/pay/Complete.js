...
import styles from '../../../../css/disasterHouse/payComplete.module.css';
...
function Complete() {
    ...
    const { updateCoverageAmounts, updateContractData } = useDisasterHouse();
    ...
    useEffect(() => {
        // 가입금액 초기화 (disasterHouse는 minCoverageAmount 기반, 기본값 0으로 초기화)
            ...
            try {
                ...
                const response = await fetch(`/disaster-api/api/v3/nft/mint/${tid}`, {
                    ...
                    body: JSON.stringify({
                        ...
                        product_cd: "17604",  // disasterHouse 상품 코드
                    }),
                });
    ...
    return (
        <>
            <DisasterHeader title="실손보상 주택 풍수해·지진재해보험" hideBackButton />
